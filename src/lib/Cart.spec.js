...
describe('Cart', () => {
  ...
  describe('checkout()', () => {
    it('should return an object with the total and the list of item', () => {
      cart.add({
        product,
        quantity: 5,
      });
  ...
  describe('special conditions', () => {
    it('should NOT apply percentage discount when the quantity is below or equals minimum', () => {
      const condition = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it('should apply percentage discount when the quantity above minimum is passed', () => {
      const condition = {
        percentage: 30,
        minimum: 2,
      };
